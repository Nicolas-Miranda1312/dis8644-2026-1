...
Yaaaaaaaaaaa es Viernes! 	( ´ ▿ ` )

---

## Apuntes de clase:

John Widlar: fue un ingeniero electrónico estadounidense y diseñador de circuitos integrados lineales (Se supone que entre todo lo que usaremos este semestre, algo lo creó el)

Widlalizar: *Romper cosas con un mazo...que lindo*


Voltaje = Intensidad de corriente x Resistencia *Ley de Ohm*

9V = I x 220 Ohms

0,04 Amperes = 40mA (MiliAmperes) en el taller hablaremos con los Milis pero en general es lo mismo.

No importa el orden de como poner la resistencia o el LED, pero debe cumplirse el circuito con el positivo o negativo o no prenderan las cosas.

Grafos: MALDITA SEA, NUNCA PENSE QUE VOLVERIA A ESCUCHAR DE LOS GRAFOS DESPUES DE DEJAR ARQUITECTURAAAAAAAAAAAAAAAAAAAAAAAAAAA!

No polarizado/ Cerámico {Capacitor: Capacitancia o Condensador } Electrolítico/ Polarizado
